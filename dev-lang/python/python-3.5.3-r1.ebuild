...
IUSE="build elibc_uclibc examples gdbm hardened ipv6 libressl openvz +ncurses +readline sqlite +ssl +threads tk wininst +xml"
...
src_prepare() {
	...
	use openvz && epatch "${FILESDIR}/3.5.3-random.patch"
