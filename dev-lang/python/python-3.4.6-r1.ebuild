...
IUSE="build elibc_uclibc examples gdbm hardened ipv6 libressl +ncurses openvz +readline sqlite +ssl +threads tk wininst +xml"
...
src_prepare() {
	...
	use openvz && epatch "${FILESDIR}/3.4.6-random.patch"
